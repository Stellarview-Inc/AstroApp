...
struct SignInView: View {
    ...
    var signInView: some View {
        VStack {
            ...
            Text("Welcome to AstroApp")
                .font(.system(.largeTitle, weight: .bold))
                .multilineTextAlignment(.center)
            
            Text("Please sign in with an account that has access to the attendance sheet")
            ...
            if userModel.errorMessage?.contains("connection appears to be offline") ?? false {
                Text("""
You seem to be offline. AstroApp
...
""")
    ...
    var addScopesView: some View {
        VStack {
            Text("AstroApp requires the following permissions:")
                .multilineTextAlignment(.center)
